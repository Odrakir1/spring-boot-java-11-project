...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2020-06-24T16:00:00Z"), u1);
		Order o2 = new Order(null, Instant.parse("2020-06-24T17:37:25Z"), u2);
		Order o3 = new Order(null, Instant.parse("2020-06-24T13:16:14Z"), u1);
