...
import com.project.practice.entities.OrderItem;
import com.project.practice.entities.Payment;
...
import com.project.practice.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment payment1 = new Payment(null, Instant.parse("2020-06-24T16:30:12Z"), o1);
